...
- (NSURL *)applicationDocumentsDirectory {
    // 下記のコードでは、アプリのドキュメントディレクリ内にある「Isshiki.MyWikitudeApp2ForiOS」という名前のディレクトリを使ってディレクトリパスを作成し、それを返しています。
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"MyWikitudeApp2ForiOS" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"MyWikitudeApp2ForiOS.sqlite"];
    NSError *error = nil;
